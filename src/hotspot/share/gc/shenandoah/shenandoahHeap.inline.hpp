...
inline oop ShenandoahHeap::evacuate_object(oop p, Thread* thread) {
  ...
  printf("p: ac %lu gc_epoch %lu region %lu | copy_val: ac %lu gc_epoch %lu region %lu", p->access_counter(), p->gc_epoch(), heap_region_index_containing(p), copy_val->access_counter(), copy_val->gc_epoch(), heap_region_index_containing(copy_val));
